...
void ssd1306_UpdateScreen(void) {
    ...
    for(uint8_t i = 0; i < SSD1306_HEIGHT/8; i++) {
        ...
        ssd1306_WriteCommand(0x02 + SSD1306_X_OFFSET_LOWER); //as we use ssd1106, 132=64, should right move 2 pixels!
        ssd1306_WriteCommand(0x10 + SSD1306_X_OFFSET_UPPER);
        ssd1306_WriteData(&SSD1306_Buffer[SSD1306_WIDTH*i],SSD1306_WIDTH);
       //0x00-0x0F set lower 4 bits of column address
       //0x10-0x1F set upper 4 bits of column address
    }
}
